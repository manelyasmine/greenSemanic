...
import { getCarbonEmissionScopesChartCustomized } from '@/lib/helper';
...
export function CarbonEmissionsScope({ sx, data, displayPer, typeReporting, startDate, endDate }: SalesProps): React.JSX.Element {
  const processedData = getCarbonEmissionScopesChartCustomized(
    data,
    displayPer,
    typeReporting,
    startDate,
